...
import Template5Design from '../templates/Template5Design';
...
export const DEFAULT_TEMPLATE5_DATA = {
    info: {
        name: 'Your Name',
        title: 'Your Title',
    },
...
export type Template5DataType = typeof DEFAULT_TEMPLATE5_DATA;

function Template5Editor({ }: Props) {
    const [data, setData] = useState<Template5DataType>({
        ...DEFAULT_TEMPLATE5_DATA,
    });
    ...
    const handleExperienceChange = (
        experience: Template5DataType['experience']
    ) => {
        setData((data) => ({
            ...data,
    ...
    const handleEducationChange = (education: Template5DataType['education']) => {
        setData((data) => ({
            ...data,
            education: education,
        }));
    ...
    const handleSkillChange = (skills: Template5DataType['skills']) => {
        setData((data) => ({
            ...data,
            skills: skills,
        }));
...
export default Template5Editor;
...
function Template3SidePanel({
    ...
    setData: React.Dispatch<React.SetStateAction<Template5DataType>>;
...
function ExperienceEditor({
    ...
    data: Template5DataType;
    handleExperienceChange: (exp: Template5DataType['experience']) => void;
}) {
    function addMore() {
...
function ExperienceInputsContainer({
    ...
    function handleChange(ev: React.ChangeEvent<HTMLInputElement>) {
        let key = ev.target.name as keyof Template5DataType['experience'][0];
    ...
    const handlePointsChange = (
        points: Template5DataType['experience'][0]['points']
    ) => {
        let experience = [...data.experience];
...
function EducationEditor({
    ...
    data: Template5DataType;
    handleEducationChange: (ed: Template5DataType['education']) => void;
}) {
    function addMore() {
    ...
    function handleChange(ev: React.ChangeEvent<HTMLInputElement>) {
        let key = ev.target.name as keyof Template5DataType['education'][0];
...
function SkillEditor({
    ...
    data: Template5DataType;
    handleSkillChange: (ed: Template5DataType['skills']) => void;
}) {
    function addMore() {
